...
void one_U1(U1 *A);         // A=1
void zero_U1(U1 *A);        // A=0

void equal_U1(U1 *A, U1 const * const B);      // A=B
void equal_dag_U1(U1 *A, U1 const * const B);  // A=B^{dag}

void plus_equal_U1(U1 *A, U1 const * const B);     // A+=B
void plus_equal_dag_U1(U1 *A, U1 const * const B); // A+=B^{dag}

void minus_equal_U1(U1 *A, U1 const * const B);     // A-=B
void minus_equal_times_real_U1(U1 *A, U1 const * const B, double r);     // A-=(r*B)
void minus_equal_dag_U1(U1 *A, U1 const * const B); // A-=B^{dag}

void lin_comb_U1(U1 *A,
                 double b, U1 const * const B,
                 double c, U1 const * const C);       // A=b*B+c*C
void lin_comb_dag1_U1(U1 *A,
                      double b, U1 const * const B,
                      double c, U1 const * const C);  // A=b*B^{dag}+c*C
void lin_comb_dag2_U1(U1 *A,
                      double b, U1 const * const B,
                      double c, U1 const * const C);  // A=b*B+c*C^{dag}
void lin_comb_dag12_U1(U1 *A,
                       double b, U1 const * const B,
                       double c, U1 const * const C); // A=b*B^{dag}+c*C^{dag}

void times_equal_real_U1(U1 *A, double r); // A*=r

void times_equal_U1(U1 *A, U1 const * const B);     // A*=B
void times_equal_dag_U1(U1 *A, U1 const * const B); // A*=B^{dag}

void times_U1(U1 *A,
              U1 const * const B,
              U1 const * const C);       // A=B*C
void times_dag1_U1(U1 *A,
                   U1 const * const B,
                   U1 const * const C);  // A=B^{dag}*C
void times_dag2_U1(U1 *A,
                   U1 const * const B,
                   U1 const * const C);  // A=B*C^{dag}
void times_dag12_U1(U1 *A,
                    U1 const * const B,
                    U1 const * const C); // A=B^{dag}*C^{dag}
