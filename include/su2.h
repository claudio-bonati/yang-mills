...
void minus_equal_times_real_Su2(Su2 *A, Su2 const * const B, double r);     // A-=(r*B)
void minus_equal_dag_Su2(Su2 *A, Su2 const * const B); // A-=B^{dag}

void lin_comb_Su2(Su2 *A,
                  double b, Su2 const * const B,
                  double c, Su2 const * const C);       // A=b*B+c*C
void lin_comb_dag1_Su2(Su2 *A,
                       double b, Su2 const * const B,
                       double c, Su2 const * const C);  // A=b*B^{dag}+c*C
void lin_comb_dag2_Su2(Su2 *A,
                       double b, Su2 const * const B,
                       double c, Su2 const * const C);  // A=b*B+c*C^{dag}
void lin_comb_dag12_Su2(Su2 *A,
                        double b, Su2 const * const B,
                        double c, Su2 const * const C); // A=b*B^{dag}+c*C^{dag}
...
void times_Su2(Su2 *A,
               Su2 const * const B,
               Su2 const * const C);       // A=B*C
void times_dag1_Su2(Su2 *A,
                    Su2 const * const B,
                    Su2 const * const C);  // A=B^{dag}*C
void times_dag2_Su2(Su2 *A,
                    Su2 const * const B,
                    Su2 const * const C);  // A=B*C^{dag}
void times_dag12_Su2(Su2 *A,
                     Su2 const * const B,
                     Su2 const * const C); // A=B^{dag}*C^{dag}
