#ifndef YM_4D_FROM_5D_C
#define YM_4D_FROM_5D_C
...
void real_main(char *in_file)
    ...
    #if STDIM!= 5
    fprintf(stderr, "This code has to be used with STDIM=5 (%s, %d)\n", __FILE__, __LINE__);
    exit(EXIT_FAILURE);
    #endif
    ...
    for(count=1; count < param.d_sample + 1; count++)
       ...
       if(count % param.d_measevery ==0 && count >= param.d_thermal)
         {
         perform_measures_4d_from_5d(&GC, &geo, &param, datafilep);
         }
